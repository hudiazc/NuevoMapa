...
public class CentroDeSimulacionEnfermeria : MonoBehaviour
{
    [SerializeField]
    Transform _destination;
    //public GameObject room201;
    public Button BCentroDeSimulacionEnfermeria;
    private NavMeshAgent _navMeshAgent;

    void Start()
    {
        //Calls the TaskOnClick/TaskWithParameters/ButtonClicked method when you click the Button
        BCentroDeSimulacionEnfermeria.onClick.AddListener(TaskOnClick);
    }

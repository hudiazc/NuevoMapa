...
public class FacultadCienciasBiologicas : MonoBehaviour
{
    [SerializeField]
    Transform _destination;
    //public GameObject room201;
    public Button BFacultadCienciasBiologicas;
    private NavMeshAgent _navMeshAgent;

    void Start()
    {
        //Calls the TaskOnClick/TaskWithParameters/ButtonClicked method when you click the Button
        BFacultadCienciasBiologicas.onClick.AddListener(TaskOnClick);
    }

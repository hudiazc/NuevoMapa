...
public class EcologiayRecursosNaturales : MonoBehaviour
{
    [SerializeField]
    Transform _destination;
    //public GameObject room201;
    public Button BEcologiayRecursosNaturales;
    private NavMeshAgent _navMeshAgent;

    void Start()
    {
        //Calls the TaskOnClick/TaskWithParameters/ButtonClicked method when you click the Button
        BEcologiayRecursosNaturales.onClick.AddListener(TaskOnClick);
    }
